...
public class PaymentService {
    ...
    private List<Transaction> getTransactionInformation(List<OrderPayment> orderPayments) {
        ...
        for (OrderPayment orderDetail2 : orderPayments) {
            Item item = new Item();
            item.setCurrency("USD").setName(orderDetail2.getProductName()).setPrice(orderDetail2.getSubTotal())
                    .setTax(orderDetail2.getTax()).setQuantity("1");
    ...
    private RedirectUrls getRedirectURLs() {
        ...
        redirectUrls.setCancelUrl("http://localhost:8080/PayPalTest3/cancel.html");
        redirectUrls.setReturnUrl("http://localhost:8080/PayPalTest3/review_payment");
        return redirectUrls;
    }
