...
<html>
    ...
    <body>
        ...
        <%
            ...
            if (cart != null) {
                Map<Integer, Product> listMap = cart.getCart();
                request.setAttribute("mapCart", listMap);
                request.setAttribute("totalPrice", cart.getTotalPrice());
            } else {
                request.setAttribute("noti", "Cart Empty");
            }
//thay vi gui mapCart len requestScope thi cos the su dung sessionScope.CART.getCart() de lay cart ve. Moi sua lai :v
%> 
                ...
                <c:forEach items="${cart.values()}" var="c">
                    ...
                    <tr>
                        ...
                        <td><form action="ProccessController" method="POST">
                                ...
                                <input name="quantity" value="${c.quantity}" hidden/>
    ...
    <h2>${requestScope.noti}</h2>
    <a href="ListController"> <button>Get Back To Shop</button></a>
    <a href="checkoutConfirm.jsp?total=${requestScope.totalPrice}"><button>Check Out</button></a>
